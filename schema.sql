...
CREATE TABLE posts (id SERIAL PRIMARY KEY, image_id INT, title TEXT, time TIMESTAMPTZ default CURRENT_TIMESTAMP);
CREATE TABLE reply_section (id SERIAL PRIMARY KEY, post_id INT, reply_id INT);
CREATE TABLE replies (id SERIAL PRIMARY KEY, reply_id INT, user_id INT, content TEXT, time TIMESTAMPTZ default CURRENT_TIMESTAMP);
CREATE TABLE votes (
